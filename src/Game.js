...
var SecondWave = require('./waves/SecondWave').SecondWave;
var Scheduler = require('./timing/Scheduler').Scheduler;
var ScoreCounter = require('./ScoreCounter').ScoreCounter;
var SimpleWave = require('./waves/SimpleWave').SimpleWave;
var SpinnerWave = require('./waves/SpinnerWave').SpinnerWave;
var SpinnerWave2 = require('./waves/SpinnerWave2').SpinnerWave2;
var SplitterWave = require('./waves/SplitterWave').SplitterWave;
